...
export const posts: BlogPost[] = [
  {
    slug: 'biggest-energy-shock-lifetimes',
    title: 'The biggest energy shock of our lifetimes, and almost no one is pricing it',
    date: 'April 10, 2026',
    content: [
      ...
      "<i>\"We tend to underestimate the complexity of our own civilisation.\"</i> — Vaclav Smil, <i>How the World Really Works</i>",
      ...
      "<b>Pillar one — ammonia</b><br/><i>This is the food equivalent of a demographic cliff. You can see it coming. Almost no one is looking.</i>",
      ...
      "<b>Pillar two — steel</b><br/><i>280 bulk carriers stranded and the construction industry hasn't noticed yet.</i>",
      ...
      "<b>Pillar three — plastics</b><br/><i>85% of Middle Eastern polyethylene exports, offline.</i>",
      ...
      "<b>Pillar four — sulfur</b><br/><i>Cascading effects. The ingredients that actually power the world just went offline.</i>",
      ...
      "<i>\"There is no quick substitution for the four pillars. The timescales of energy transitions are not quarters. They are generations.\"</i> — Vaclav Smil",
      ...
      "<b>The S&P 500 is two percent from all-time highs.</b>",
