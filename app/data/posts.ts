...
export const posts: BlogPost[] = [
  {
    ...
    content: [
      ...
      "<i>\"We tend to underestimate the complexity of our own civilisation.\" Vaclav Smil, How the World Really Works</i>",
      ...
      "<i>\"There is no quick substitution for the four pillars. The timescales of energy transitions are not quarters. They are generations.\" Vaclav Smil</i>",
