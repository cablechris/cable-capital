...
const TraitPropagationVisualization = () => {
    ...
    <div className="p-4 bg-white shadow-lg rounded-lg">
      ...
      <ResponsiveContainer width="100%" height={500}>
        <LineChart data={data}>
          ...
          <Line 
            type="monotone" 
            dataKey="originalTraits" 
            stroke="#FF6B6B" 
            strokeWidth={3}
            name="Original Traits"
          />
          <Line 
            type="monotone" 
            dataKey="hybridTraits" 
            stroke="#4ECDC4" 
            strokeWidth={3}
            name="Hybrid Traits"
          />
          <Line 
            type="monotone" 
            dataKey="subculturalTraits" 
            stroke="#45B7D1" 
            strokeWidth={3}
            name="Subcultural Traits"
          />
          <Line 
            type="monotone" 
            dataKey="metaPreferenceTraits" 
            stroke="#FDCB6E" 
            strokeWidth={3}
            name="Meta-Preference Traits"
          />
        </LineChart>
      </ResponsiveContainer>
